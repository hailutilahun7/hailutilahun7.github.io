...
<body>
        ...
        <div class="container">
            <div class="grid-2" style="align-items: center;">
                <div>
                    ...
                    <p>The focus is not only on developing ideas, but on connecting knowledge, resources, partnerships, and implementation to create practical and scalable impact. I have also participated on youth leadership and climate action on COP programs and UNFCCC processes.</p>
        ...
        <div class="container">
            ...
            <div class="grid-3">
                ...
                <div class="card">
                    ...
                    <p>Experience and professional focus across climate mitigation, adaptation, climate-smart agriculture, biodiversity, agroforestry, ecosystem restoration, carbon markets, and climate finance.</p>
                </div>
                <div class="card">
                ...
                <div class="card">
                    ...
                    <p>A commitment to building relationships with international foundations, donors, NGOs, investors, research institutions, companies, and development organizations.</p>
                </div>
                <div class="card">
                    <div class="card-icon"><i class="fa-solid fa-chart-line"></i></div>
                    <h3>Measurable Impact</h3>
                    <p>My approach integrates science, investment, implementation, and measurable impact.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="expertise">
        <div class="container">
            <div class="section-title">
                ...
                <p>Multidisciplinary capability built over 8+ years of scientific research and community development.</p>
            </div>
            ...
            <div class="grid-3">
                ...
                <div class="card">
                    ...
                    <ul class="green-bullets">
                        ...
                        <li>Agroforestry</li>
                        <li>Forest and Landscape Restoration</li>
                        <li>Ecosystem Rehabilitation</li>
                        <li>Sustainable Land Management</li>
                        <li>Nature-Based Solutions & Community Conservation</li>
                    </ul>
                </div>
                ...
                <div class="card">
                    ...
                    <ul class="green-bullets">
                        ...
                        <li>Climate-Smart Agriculture & Innovation</li>
                ...
                <div class="card">
                    ...
                    <ul class="green-bullets">
                        ...
                        <li>Market Linkage & International Trade</li>
                ...
                <div class="card">
                    ...
                    <ul class="green-bullets">
                        ...
                        <li>Evidence-Based Development & Research Partnerships</li>
                    </ul>
                </div>
    ...
    <section id="partnerships" class="bg-white">
        <div class="container">
            <div class="section-title">
            ...
            <div class="grid-2">
                ...
                <div class="card">
                    ...
                    <ul class="green-bullets">
                        ...
                        <li>Sustainable Livestock Systems</li>
    ...
    <!-- Consulting Services -->
    <section id="consulting" class="bg-white">
        <div class="container">
            <div class="section-title">
            ...
            <div class="grid-3">
                ...
                <div class="card">
                    ...
                    <ul class="green-bullets">
                        ...
                        <li>Monitoring, Evaluation, and Learning (MEL) Frameworks</li>
